...
class CashAuditController extends Controller
{
    ...
    {
        $validShifts = Shifts::pluck('name_shift')->toArray();

        $request->validate([
            'user_id'        => 'required|exists:users,id',
            'start_date'     => 'required|date',
            'end_date'       => 'nullable|date|after_or_equal:start_date',
            'shift'          => ['required', Rule::in($validShifts)],
            'initial_amount' => 'required|numeric|min:0',
            'tips_card'      => 'nullable|numeric|min:0',
            'tips_cash'      => 'nullable|numeric|min:0',
        ...
        $cashAudit = \App\Models\CashAudit::create([
            ...
            'tips_card'      => $request->tips_card,
            'tips_cash'      => $request->tips_cash,
