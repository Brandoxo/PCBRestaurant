...
const editTable = (id) => {
    if (
        currentTable.value.number ===
        props.mesas.data.find(
            (table) =>
                table.number === currentTable.value.number && table.id !== id
        )?.number
    ) {
...
const filteredTables = computed(() => {
    if (!searchQuery.value) return props.mesas.data;
    return props.mesas.data.filter((table) =>
        ...
        <div class="p-6">
            ...
            <form class="flex flex-col">
                ...
                <div class="flex justify-between">
                    ...
                    <button
                        @click="editTable(currentTable.id)"
                        type="button"
